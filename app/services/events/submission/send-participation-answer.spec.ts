...
describe('#sendParticipationAnswer', () => {
  ...
  it('confirms a proposal', async () => {
    ...
    await sendParticipationAnswer({ speakerId: speaker.id, proposalId: proposal.id, participation: 'CONFIRMED' });
  ...
  it('declines a proposal', async () => {
    ...
    await sendParticipationAnswer({ speakerId: speaker.id, proposalId: proposal.id, participation: 'DECLINED' });
  ...
  it('throws an error when proposal not found', async () => {
    ...
    const result = await sendParticipationAnswer({
