      ...
      <SonnerToaster
        ...
        toastOptions={{
          ...
          classNames: {
            ...
            success: 'text-green-600 border border-green-300 bg-green-50',
            warning: 'text-yellow-600 border border-yellow-300 bg-yellow-50',
            info: 'text-info-600 border border-gray-200 bg-white',
            title: 'text-gray-900',
