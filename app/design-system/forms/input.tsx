...
const containerStyle = cva(
  'flex w-full rounded-md border-0 ring-1 ring-inset focus-within:ring-2 focus-within:ring-inset',
  {
    variants: {
      color: {
      ...
      error: {
        true: 'ring-red-300 focus:border-red-500 focus:ring-red-500',
      },
    },
