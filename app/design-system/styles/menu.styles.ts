...
export const menuItem = cva(
  ['mx-2 flex grow cursor-pointer items-center gap-2 rounded-lg px-2 py-1.5 text-sm font-medium'],
  {
    variants: {
      variant: {
        primary:
          'text-gray-700 data-disabled:cursor-not-allowed data-disabled:text-gray-400 data-focus:bg-gray-100 data-focus:text-gray-900',
        important: 'font-semibold text-red-700 data-disabled:text-red-400 data-focus:bg-red-100',
      },
    },
