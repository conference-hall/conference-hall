...
import { ReviewsMetrics as ReviewsMetricsService } from '~/.server/event-metrics/reviews-metrics.ts';
...
import { ReviewsMetrics } from './components/overview-page/reviews-metrics.tsx';
...
export const loader = async ({ request, params }: Route.LoaderArgs) => {
  ...
  } else if (searchParams.get('tab') === 'reviews') {
    const metrics = await ReviewsMetricsService.for(userId, params.team, params.event).get();
    return { tab: 'reviews', metrics } as const;
  } else {
