...
function EventProposalDeleteModal({
  isOpen,
  onClose,
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  Are you sure you want to delete your proposal? The talk will
                  still be in your profile, so you will be able to submit it
                  again later.
                </p>
              </div>
            </div>
