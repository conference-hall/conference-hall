...
export default [
  // Application pages (optional authentication middleware)
  layout('./app-platform/app-layout.tsx', { id: 'app' }, [
    // Homepage
  ...
  // Resource routes (no authentication middleware)
  route('api/auth/*', './features/auth/api.ts'),
