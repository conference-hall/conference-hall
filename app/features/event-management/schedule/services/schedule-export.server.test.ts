import type { Event, Schedule, ScheduleTrack, Team, User } from '@conference-hall/database';
...
import { scheduleTrackFactory } from '@conference-hall/database/tests/factories/schedule-track.ts';
