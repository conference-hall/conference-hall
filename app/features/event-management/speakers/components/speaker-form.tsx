...
export function SpeakerForm({ formId, defaultValues = {}, errors, className }: SpeakerFormProps) {
  ...
  return (
    <Form method="POST" id={formId} className={cx('space-y-6', className)} preventScrollReset>
      <Input name="email" type="email" label={t('common.email')} defaultValue={email} error={errors?.email} required />
