...
import type { SurveyDetailedAnswer } from '~/features/event-management/settings/services/survey.types.ts';
...
import { ProposalSearchBuilder } from '../../../../.server/proposal-search-builder.ts';
import type { ProposalsFilters } from '../../../../.server/proposal-search-builder.types.ts';
import { UserEvent } from '../../../../.server/user-event.ts';
import { SpeakerSurvey } from '../../../event-participation/speaker-survey/services/speaker-survey.server.ts';
import type { SocialLinks } from '../../../speaker/settings/services/speaker-profile.schema.server.ts';
