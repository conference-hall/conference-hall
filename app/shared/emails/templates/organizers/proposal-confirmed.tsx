...
export type TemplateData = {
  ...
  proposal: { id: string; routeId: string; title: string; speakers: Array<{ name: string }> };
};
  ...
  return (
    <BaseEventEmail locale={locale} logoUrl={event.logoUrl}>
      ...
      <Section className="my-8 text-center">
        <Button href={buildReviewProposalUrl(event.team.slug, event.slug, proposal.routeId)} className={styles.button}>
