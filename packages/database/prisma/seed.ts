...
import { eventCategoryFactory } from '../tests/factories/categories.js';
import { commentFactory } from '../tests/factories/comments.js';
import { eventFactory } from '../tests/factories/events.js';
import { eventFormatFactory } from '../tests/factories/formats.js';
import { organizerKeyFactory } from '../tests/factories/organizer-key.js';
import { eventProposalTagFactory } from '../tests/factories/proposal-tags.ts';
import { proposalFactory } from '../tests/factories/proposals.js';
import { reviewFactory } from '../tests/factories/reviews.js';
import { talkFactory } from '../tests/factories/talks.js';
import { teamFactory } from '../tests/factories/team.js';
import { userFactory } from '../tests/factories/users.js';
