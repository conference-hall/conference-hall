...
-- AddForeignKey
ALTER TABLE "event_speakers" ADD CONSTRAINT "event_speakers_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_proposals_speakers" ADD CONSTRAINT "_proposals_speakers_A_fkey" FOREIGN KEY ("A") REFERENCES "event_speakers"("id") ON DELETE CASCADE ON UPDATE CASCADE;
