...
import { CUSTOM_EMAIL_TEMPLATES } from '@conference-hall/webapp/app/shared/emails/email.types.ts';
import { SUPPORTED_LANGUAGES } from '@conference-hall/webapp/app/shared/i18n/i18n.ts';
