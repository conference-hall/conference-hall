...
import type { EventEmailNotificationsKeys } from '@conference-hall/shared/types/events.types.ts';
...
import type { ProposalSaveData } from './speaker-proposal.schema.server.ts';
