import type { ConversationContextType, ConversationReaction, User } from '@conference-hall/database';
import { db } from '@conference-hall/database';
import type { EmojiReaction } from '@conference-hall/shared/types/emojis.types.ts';
import type {
