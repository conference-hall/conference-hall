import type { ReviewFeeling } from '@conference-hall/shared/types/proposals.types.ts';
        ...
        >
          {options.map((option, index) => (
            <Radio
              ...
              data-review-input
            >
              <div role="button" tabIndex={0} className="cursor-pointer" onMouseOver={() => setOverIndex(index)}>
