import type { Event, EventSpeaker, Team, User } from '@conference-hall/database';
...
import type { EventSpeakerSaveData } from '@conference-hall/shared/types/speaker.types.ts';
